...
function ansible_wait_ckb_benchmark() {
    ...
    ansible-playbook playbook.yml -e 'hostname=bastions' -e 'node=bastions ckb_benchmark_url=http://172.31.37.178:8020' -t ckb_benchmark_miner_start
    ...
    ansible-playbook playbook.yml -e 'hostname=bastions' -e 'node=bastions ckb_benchmark_url=http://172.31.37.178:8020 ckb_mining_interval_ms=10 ckb_bench_min_tx_size=2 ckb_n_blocks=340' -t ckb_bench_miner &
