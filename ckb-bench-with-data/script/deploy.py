#!/usr/bin/env python3
"""
CKB Bench With Data deployment script - replaces Ansible playbooks.

Usage:
    python deploy.py setup
    python deploy.py run <data_count>        # e.g. python deploy.py run 1000w
...
def run_benchmark(paths):
    ...
    with get_ssh(bastions_host, paths) as ssh:
        ...
        bench.miner_start(
            rpc_url=bastions_vars.get("ckb_benchmark_url", rpc_urls[0]),
...
def main():
    parser = argparse.ArgumentParser(description="CKB Bench With Data deployment")
