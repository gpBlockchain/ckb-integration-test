...
#    ansible-playbook playbook.yml -e 'hostname=bastions node=bastions'  -t ckb_bench_stop
    ...
    ansible-playbook playbook.yml -e 'hostname=bastions node=bastions ckb_bench_n_inout=1 ckb_bench_min_fee=2000 ckb_bench_max_fee=5000 ckb_benchmark_logfile=/var/lib/ckb-benchmark/ckb-bench-4.log'  -t ckb_benchmark_with_tps_and_fee &
    wait
